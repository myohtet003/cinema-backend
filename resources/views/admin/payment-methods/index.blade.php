    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 font-medium">Manage your QR codes and payment providers</p>
            </div>
                        ...
                        <tbody class="divide-y divide-gray-100 bg-white">
                            @forelse($paymentMethods as $method)
                                <tr class="hover:bg-indigo-50/30 cursor-pointer transition-colors group"
                                    onclick="window.location='{{ route('payment_methods.edit', $method) }}'">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-4">
                                            <div
                                                class="h-12 w-12 flex-shrink-0 overflow-hidden rounded-lg bg-white border border-gray-100 shadow-sm transition group-hover:shadow-md">
                                                @if ($method->photo)
                                                    <img src="{{ asset('storage/' . $method->photo) }}"
                                                        class="h-full w-full object-contain p-1">
                                                @else
                                                    <div
                                                        class="flex items-center justify-center h-full bg-gray-50 text-gray-300">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        @else
                                            <span
                                                class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold bg-gray-50 text-gray-500 border border-gray-100">
                                                Disabled
                                            </span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-right" onclick="event.stopPropagation()">
                                        <div class="flex justify-end items-center gap-4">
                                            ...
                                            <form action="{{ route('payment_methods.destroy', $method) }}"
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-20 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <div class="text-gray-500 font-medium">No payment methods configured.</div>
                                            <a href="{{ route('payment_methods.create') }}"
